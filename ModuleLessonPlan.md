...
dbt day 1 lab
dbt day 1 lecture
Complex Data Types in Snowflake (VARIANT)
UDFs in Snowflake
How to use Snowpark
Snowflake Query Optimization
Capstone Showcase with Billy Switzer
Capstone Showcase with Jesse Charbneau
Change Data Capture (CDC) and Snowflake basics Lecture
Data Modeling
Growth Accounting Models Lecture
Date List and Time Series Analysis
Grouping sets and Window functions Lecture
Grouping sets and Window functions Lab
Growth Accounting Models Lab
Change Data Capture (CDC) and Snowflake basics Lab
How to use snowpark and Snowflake optimization Lecture
How to use snowpark and Snowflake optimization Lab
